...
async function approveCalldata(TONContract, PaymasterContract, maxApproveAmount) {
...
async function main() {
  ...
  let callData = await approveCalldata(TONContract, TokamakPaymasterContract, maxApproveAmount);
  ...
  // check 3. approve 되었으니, allowance 가 늘어난다. 수수료가 줄어든다. (PayMaster의 예치금이 줄거나 TON 잔액이 준다.)
  //============================================================
  `)
  ...
  let tonAllowanceOfUser2ContractPrev = await TONContract.allowance(user2ContractAddress, TokamakPaymasterContract.address)
  ...
  console.log('ton Allowance User2Contract Prev',
    ethers.utils.formatEther(tonAllowanceOfUser2ContractPrev) , "TON")
  ...
  let approveData = await approveCalldata(TONContract, TokamakPaymasterContract, maxApproveAmount) ;
  ...
  let tonAllowanceOfUser2ContractAfter = await TONContract.allowance(user2ContractAddress, TokamakPaymasterContract.address)
  ...
  console.log('ton Allowance User2Contract After',
    ethers.utils.formatEther(tonAllowanceOfUser2ContractAfter) , "TON")
  ...
  console.log(">> check 2. ton balance of user2Contract",
    ethers.utils.formatEther(tonBalanceOfUser2ContractPrev) , "TON -> ",
    ethers.utils.formatEther(tonBalanceOfUser2ContractAfter) , "TON " )

  console.log(">> check 3. ton allowance of user2Contract about Paymaster",
    ethers.utils.formatEther(tonAllowanceOfUser2ContractPrev) , "TON -> ",
    ethers.utils.formatEther(tonAllowanceOfUser2ContractAfter) , "TON " )
